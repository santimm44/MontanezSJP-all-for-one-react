...
const GreaterThanOrLessThan = () => {
  ...
  const fetchAPI = async () => {
    setFetchData(await greaterThanOrLessThanAPICall(firstNumber, secondNumber));
  };
  ...
  return (
    <div className="h-screen bg-[url(/public/assets/background.jpeg)] bg-[length:100vw_100vh] bg-no-repeat bg-center grid grid-cols-12 grid-rows-12">
      ...
      >
        ...
        <div>
          <p className="m-o rounded-[2rem] text-fluid bg-[#FAF9F6] p-[1rem_0rem] shadow-[.5rem_.5rem_0rem_.5rem_#FF4500] z-2 text-black">
