...
function App() {
  ...
  return (
    <div className="h-screen bg-[url(/public/assets/background.jpeg)] bg-[length:100vw_100vh] bg-no-repeat bg-center grid grid-cols-12 grid-rows-12">
      <NavBar />
      <div className="md:row-start-3 max-md:col-start-6 col-end-8 max-md:row-start-2 md:col-start-2 md:row-end-11 md:col-end-7">
        <img
          className="h-full w-full"
          src="public/assets/chess-rook-regular.svg"
          alt="large castle icon"
        />
      </div>

      <div className="max-md:col-start-2 max-md:col-end-12 max-md:row-start-3 max-md:row-end-12 max-md:p-4 md:col-start-8 md:col-end-12 md:row-start-3 md:p-8 md:row-end-11 bg-[#85735D] shadow-[.5rem_.5rem_0rem_.5rem_#000] rounded-[2rem] grid grid-cols-3 grid-rows-3 h-full w-full">
